...
##Setup
There are neither any dependencies needed nor path specific files as all are relative. The program will always output to a console. 
...
Account* | account[] (object) | Dynamically allocated array of accounts

_Constructors_

Type | Parameters | Description
---- | ---------- | -----------
Default | None | Initializes active_accounts to 0.
1 Parameter | Account object | Instantiates and adds an Account to the database and increments active_accounts
...
Type | Parameters | Description
---- | ---------- | -----------
Default | int accnum, string type, double balance, Depositor object | Instantiates the Account object with these values, if omitted, then it sets to their default values (i.e. 0, "" ...)
...
Type | Parameters | Description
---- | ---------- | -----------
Default | Name object, string ssn | If parameters are omitted, their default values will be assigned; name = Name() and ssn = ""
...
Type | Parameters | Description
---- | ---------- | -----------
Default | string first, string last | If parameters are omitted their default values will be NULL ("")
...
Type | Parameters | Description
---- | ---------- | -----------
Default | string type, double amount | If the values are omitted, they will be assigned to their default values
